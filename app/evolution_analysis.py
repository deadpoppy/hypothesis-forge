...
def analyze_evolution_payload(data: Dict[str, Any], label: str = "") -> Dict[str, Any]:
    ...
    for cycle in cycles:
        ...
        final_step = steps.get("ranking_final") or steps.get("ranking") or {}
        ...
        cycle_summaries.append(
            {
                ...
                "full_review_evolved_duration": round(_step_duration(steps.get("full_review_evolved")), 2),
    ...
    for report in reports:
        ...
        for cycle in report["cycle_summaries"]:
            parts.append(
                ...
                f"full_review_evolved={cycle['full_review_evolved_duration']}s, "
